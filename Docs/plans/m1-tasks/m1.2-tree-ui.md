...
- [x] TreeController.cs 컴파일 성공
- [x] WoodCounterUI.cs 컴파일 성공
- [x] 나무 클릭 시 GameManager.CurrentWood 증가
- [x] WoodCounterUI에 현재 목재량 표시
- [x] 1000 이상 → "1.0K" 포맷 표시
- [x] 1000000 이상 → "1.0M" 포맷 표시
